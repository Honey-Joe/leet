...
const Header = () => {
  return (
    <>
      <div className="max-w-[100%] bg-[url(https://ik.imagekit.io/HoneyJoe/leet/leet%201.png?updatedAt=1731663861314)] bg-cover ">
        <div className="grid grid-cols-1 lg:grid-cols-2 w-[90%] mx-auto justify-center items-center py-5 lg:pt-[100px]">
          <div>
          ...
          <div className="flex flex-col justify-start items-center lg:gap-6">
            <div className=" md:pt-10 pt-5">
              <div className=" flex items-center justify-center gap-2 relative">
                <h1 className=" text-[26px] text-black text-center font-[Poppins] lg:text-[28px] font-bold lg:text-white md:text-[30px] text-nowrap">
                  Embark On A
                </h1>
              </div>
              <h1 className=" text-[26px] font-[Poppins] text-center lg:text-[23px] font-bold text-black lg:text-[#fff] md:text-[30px]">
