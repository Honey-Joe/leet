        ...
        <div className=" w-full border-t-[1px] py-7 mt-24 border-[#000]">
          <div className=" 3xl:container w-[90%] xl:w-[90%] mx-auto">
            <div className=" lg:grid lg:grid-cols-2 grid-cols-1 flex flex-col items-center ">
              ...
              <div className=" ">
              <ul className='grid grid-cols-3 lg:grid-cols-5 lg:flex-row gap-5  lg:justify-end md:pt-3 lg:p-0 pt-4'>
                  <li className='  flex items-center group'><div className=" w-0 h-1 rounded-lg bg-[#000] group-hover:w-4" id="move"></div> <a href="" className=" font-[poppins] font-medium group-hover:text-[#000] ">About</a></li>
